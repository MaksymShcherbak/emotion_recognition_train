...
client_progress = {}
lock = Lock()  # Ensure thread-safe access to client_progress
...
def update_progress(clientId, new_progress):
    ...
    print(f"Updated progress for client {clientId}: {new_progress}")  # Debugging print
...
def post_predict_video():
    ...
    video_file.save(video_file_path)  # Save the file here
